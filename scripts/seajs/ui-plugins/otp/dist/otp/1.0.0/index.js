define("otp/1.0.0/index", ["jquery","otp/1.0.0/OtpImageSuite","otp/1.0.0/otpAPI"], function(require, exports, module){
var $ = require("jquery");
var OtpImageSuite = require("otp/1.0.0/OtpImageSuite");
// export otp sample service to client, allow us extend it to suit for customized bisuness.
var otpService = require("otp/1.0.0/otpAPI");
...
define("otp/1.0.0/OtpImageSuite", [], function(require, exports, module){
/**
 * OTP短信+图片验证码控件
 *
 * @class OtpImageSuite
...
define("otp/1.0.0/otpAPI", [], function(require, exports, module){
(function($) {
